...
import { getMessage, sendMessage, deleteChat, clearChat, deleteMessage, createGroup, updateGroup, addMemberToGroup, leaveGroup, deleteGroup, markAsRead, removeMember } from "../controller/message.controller.js";
...
router.put("/remove-member/:id", secureRoute, removeMember)
